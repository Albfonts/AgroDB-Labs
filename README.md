...
O sistema permitirá controlar produtores, talhões, safras, culturas, máquinas, funcionários, estoque, compras e vendas.
...
Projeto desenvolvido para construção de portfólio na área de Banco de Dados.
